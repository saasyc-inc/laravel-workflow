...
<script src="/vendor/yiche/workflow/js/jquery-latest.js"></script>
<script src="/vendor/yiche/workflow/js/d3.v3.min.js"></script>
<script src="/vendor/yiche/workflow/js/dagre-d3.min.js"></script>
<script>
